...
public class StateView extends View {
    ...
    private static final int RETRY = 0x00000001;
    private static final int LOADING = 0x00000002;
     ...
     * @return StateView
     */
    private static StateView inject(@NonNull Activity activity, boolean hasActionBar) {
     ...
     * @return StateView
     */
    private static StateView inject(@NonNull ViewGroup parent, boolean hasActionBar) {
     ...
     * @return StateView
     */
    private static StateView inject(@NonNull View view, boolean hasActionBar) {
    ...
    public StateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEmptyResource == 0) {
            mEmptyResource = R.layout.fq_base_empty;
        }
        if (mRetryResource == 0) {
            mRetryResource = R.layout.fq_base_retry;
        }
        if (mLoadingResource == 0) {
            mLoadingResource = R.layout.fq_base_loading;
        }
    ...
    public View showRetry() {
        if (mRetryView == null) {
            ...
            View btnReload = mRetryView.findViewById(R.id.tv_btn_reload);
            if (btnReload != null) {
    ...
    public View showLoading() {
        if (mLoadingView == null) {
            ...
            mLoadingImageView = mLoadingView.findViewById(R.id.iv_loading);
        }
        showView(mLoadingView);
        if (mLoadingImageView != null) {
            mLoadingImageView.showLoading();
        }
        return mLoadingView;
    }
