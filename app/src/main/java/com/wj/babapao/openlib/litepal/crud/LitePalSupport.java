...
public class LitePalSupport {
     ...
     *
     * @param fieldName The name of field to update into default value.
     */
     ...
     * table.
     *
     * @param associatedTableName The table name of associated model.
     * @param associatedId        The {@link #baseObjId} of associated model after it is saved.
     */
     ...
     * corresponding table.
     *
     * @param associatedTableName The simple class name of associated model.
     * @param associatedId        The {@link #baseObjId} of associated model after it is saved.
     */
     ...
     *
     * @param foreignKeyName The name of foreign key.
     */
