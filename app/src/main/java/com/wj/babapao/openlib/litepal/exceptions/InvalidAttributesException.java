...
package com.wj.babapao.openlib.litepal.exceptions;
...
public class InvalidAttributesException extends RuntimeException {
	 ...
	 */
	public static final String DBNAME_IS_EMPTY_OR_NOT_DEFINED = "dbname is empty or not defined in litepal.xml file, or your localLitepal.xml file is missing.";
