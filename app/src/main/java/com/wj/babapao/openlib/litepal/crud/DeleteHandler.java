...
public class DeleteHandler extends DataHandler {
     ...
     * will be removed too.
     *
     * @param modelClass Which table to delete from.
     ...
     *
     * @param modelClass To get the table name and combine with id as a foreign key
     *                   column.
     * @param id         Delete all the rows which referenced with this id.
     ...
     *
     * @param modelClass             Used to get the generic table name and value id column.
     * @param supportedGenericFields List of all supported generic fields.
     * @param ids                    The id array of models.
     */
