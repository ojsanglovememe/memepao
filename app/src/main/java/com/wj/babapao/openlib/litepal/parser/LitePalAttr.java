...
package com.wj.babapao.openlib.litepal.parser;

import android.text.TextUtils;


import com.wj.babapao.openlib.litepal.exceptions.InvalidAttributesException;
...
public final class LitePalAttr {
    ...
    public List<String> getClassNames() {
        if (classNames == null) {
            ...
            classNames.add(Const.Utils.TABLE_SCHEMA_CLASS_NAME);
